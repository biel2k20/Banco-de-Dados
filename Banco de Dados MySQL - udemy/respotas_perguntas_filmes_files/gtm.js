...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"ja_JP\"==",["escape",["macro",18],8,16],"||\"ja-JP\"==",["escape",["macro",18],8,16],"||\"jp-JP\"==",["escape",["macro",18],8,16],"||\"jp_JP\"==",["escape",["macro",18],8,16],"})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
  ...
  "tags":[{
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003E(function(){var a=document.body.getAttribute(\"data-clp-course-id\");a\u0026\u0026fbq(\"track\",\"ViewContent\",{content_ids:a,content_type:\"product\",course_avg_rating:",["escape",["macro",23],8,16],",course_category:",["escape",["macro",24],8,16],",course_instructor_name:",["escape",["macro",25],8,16],",course_language:",["escape",["macro",21],8,16],",course_length_minutes:",["escape",["macro",26],8,16],",course_locale:",["escape",["macro",27],8,16],",course_num_enrollments:",["escape",["macro",28],8,16],",course_subcategory:",["escape",["macro",29],8,16],",course_topic:",["escape",["macro",30],8,16],",user_language:",["escape",["macro",20],8,16],",\nuser_locale:",["escape",["macro",31],8,16],",user_location:",["escape",["macro",32],8,16],",has_made_paid_purchase:",["escape",["macro",33],8,16],"})})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "setup_tags":["list",["tag",0,1]],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript\u003E(function(){var b=",["escape",["macro",35],8,16],".map(function(a){return a.buyableId}),c=",["escape",["macro",35],8,16],".map(function(a){course=a.courseAnalytics;return{id:a.buyableId,quantity:1,course_avg_rating:course.course_avg_rating,course_category:course.course_category,course_instructor_name:course.course_instructor_name,course_language:course.course_language,course_length_minutes:course.course_length_minutes,course_locale:course.course_locale,course_num_enrollments:course.course_num_enrollments,course_subcategory:course.course_subcategory,\ncourse_topic:course.course_topic}});fbq(\"track\",\"Purchase\",{content_ids:b,content_type:\"product\",contents:c,order_id:",["escape",["macro",36],8,16],",value:",["escape",["macro",6],8,16],",currency:\"USD\",user_language:",["escape",["macro",20],8,16],",user_locale:",["escape",["macro",31],8,16],",user_location:",["escape",["macro",32],8,16],",has_made_paid_purchase:",["escape",["macro",33],8,16],",is_first_paid_purchase:",["escape",["macro",37],8,16],"})})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":true,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "vtp_usePostscribe":true,
      ...
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.paypalDDL=window.paypalDDL||[];paypalDDL.push({event:\"txnSuccess\",txn_id:",["escape",["macro",36],8,16],",tpv:",["escape",["macro",6],8,16],",curr:\"USD\",prcd:",["escape",["macro",41],8,16],",srce:\"other\"});\u003C\/script\u003E\n"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":380
  ...
  "rules":[
    [["if",0,3],["unless",1,2],["add",3,77]],
    [["if",6,7],["add",4,11,12,15,17,18,22,25,27,31,46,57,58,65,66,69,2,72,73,76,78,81]],
    [["if",5,8],["add",5,6]],
    [["if",4,5],["add",7],["block",3,9,29,40,0,45,51,54,59,63,1,74,75,77,79]],
    [["if",5],["add",7,45,59,62,32,33,35,36,37]],
    [["if",5,10],["unless",9],["add",8,16]],
    [["if",11,12],["add",9]],
    [["if",13,14,15],["add",10]],
    [["if",5,16],["add",13,49]],
    [["if",15,17,18],["add",14,50]],
    [["if",5,19],["add",16]],
    [["if",5,20],["add",16]],
    [["if",5,21],["add",16],["block",51]],
    [["if",5,19,22],["add",16]],
    [["if",5,23],["add",16]],
    [["if",5,24],["add",16]],
    [["if",5,25],["add",16]],
    ...
    [["if",5,28],["add",19]],
    [["if",29],["add",20]],
    [["if",5,30],["add",21,24,55]],
    [["if",5,31],["add",23,28,30,47,67,2,70,76,80]],
    [["if",5,32],["add",26]],
    [["if",5,33],["add",26]],
    [["if",5,34],["add",26]],
    [["if",0,5,35],["add",29,54,74,75,79]],
    [["if",5,36],["add",34]],
    [["if",39],["unless",37,38],["add",38]],
    [["if",3],["add",39]],
    [["if",5,40],["add",40],["block",51,59,64,78]],
    [["if",5,41],["unless",42],["add",40]],
    [["if",43,44],["add",40]],
    [["if",5,47],["add",0]],
    [["if",49,50],["add",41]],
    [["if",3,51],["add",42]],
    [["if",15,52],["add",43,60,68,2,71]],
    [["if",53,54],["add",44]],
    [["if",6,55],["add",48]],
    [["if",0,5],["unless",1,45],["add",51,63,1]],
    [["if",6,7,35],["add",52,53]],
    [["if",61,62,63,64],["add",56]],
    [["if",15,65],["add",61]],
    [["if",62,64],["add",64]],
    [["if",5,45],["block",40,0]],
    [["if",5,46],["block",40]],
    [["if",5,48],["block",0]],
    [["if",5,56],["block",51,59,64,78]],
    [["if",5,57],["block",51,59,64,78]],
    [["if",5,58],["block",51,59,64,78]],
    [["if",5,59],["block",51]],
    [["if",5,60],["block",51]],
    [["if",3,66],["block",77]]]
},
...
return null},Cf=!1;if(K.querySelectorAll)try{var Df=K.querySelectorAll(":root");Df&&1==Df.length&&Df[0]==K.documentElement&&(Cf=!0)}catch(a){}var zf=Cf;var Gd={},Rf=null,Sf=Math.random();Gd.w="GTM-7BF3X";Gd.Qb="5k1";Gd.Sd="";var Tf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Uf="www.googletagmanager.com/gtm.js";
var Vf=Uf,Wf=null,Xf=null,Yf=null,Zf="//www.googletagmanager.com/a?id="+Gd.w+"&cv=337",$f={},ag={},bg=function(){var a=Rf.sequence||0;Rf.sequence=a+1;return a};
...
Z.b.tl=["google"],function(){function a(b){return function(){if(b.gd&&b.jd>=b.gd)b.cd&&U("self").clearInterval(b.cd);else{b.jd++;var c=(new Date).getTime();fo({event:b.S,"gtm.timerId":b.cd,"gtm.timerEventNumber":b.jd,"gtm.timerInterval":b.interval,"gtm.timerLimit":b.gd,"gtm.timerStartTime":b.af,"gtm.timerCurrentTime":c,"gtm.timerElapsedTime":c-b.af,"gtm.triggers":b.Oh})}}}(function(b){Z.__tl=b;Z.__tl.g="tl";Z.__tl.h=!0;Z.__tl.priorityOverride=0})(function(b){N(b.vtp_gtmOnSuccess);if(!isNaN(b.vtp_interval)){var c=
{S:b.vtp_eventName,jd:0,interval:Number(b.vtp_interval),gd:isNaN(b.vtp_limit)?0:Number(b.vtp_limit),Oh:String(b.vtp_uniqueTriggerId||"0"),af:(new Date).getTime()};c.cd=U("self").setInterval(a(c),0>Number(b.vtp_interval)?0:Number(b.vtp_interval))}})}();
