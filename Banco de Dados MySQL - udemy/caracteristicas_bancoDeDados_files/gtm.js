...
return null},Df=!1;if(I.querySelectorAll)try{var Ef=I.querySelectorAll(":root");Ef&&1==Ef.length&&Ef[0]==I.documentElement&&(Df=!0)}catch(a){}var Af=Df;var Hd={},Sf=null,Tf=Math.random();Hd.w="GTM-7BF3X";Hd.Rb="5e1";Hd.Td="";var Uf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Vf="www.googletagmanager.com/gtm.js";
var Wf=Vf,Xf=null,Yf=null,Zf=null,$f="//www.googletagmanager.com/a?id="+Hd.w+"&cv=337",ag={},bg={},cg=function(){var a=Sf.sequence||0;Sf.sequence=a+1;return a};
...
Z.b.tg=["google"],function(){function a(k){g.push(k);1<g.length||K(function(){var l=g.join(",");g=[];fo({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var m=d[l],n=m.indexOf(k);-1!==n&&(m.splice(n,1),m.length||a(l))}function c(k){K(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,m=k.vtp_triggerIds,n=k.vtp_firingId;if(k.vtp_isListeningTag){var r=e[n];r?b(n,r):f.push(n)}else{d[l]=m;for(var t=0,q;q=m[t];t++)e[q]=l;for(var u=0;u<f.length;u++)b(f[u],l)}}var d={},e={},f=[],g=[];Z.__tg=c;Z.__tg.g="tg";Z.__tg.h=!0;Z.__tg.priorityOverride=0}();
